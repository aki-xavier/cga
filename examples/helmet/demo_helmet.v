...
// Run: v run examples/helmet/demo_helmet.v
import cga
import os
...
fn main() {
	...
	scene.add_light(cga.directional_light(cga.color_hex(0xFFFFFF), 0.8, [0.5, 1.0, 0.6]!))
	...
	mut camera := cga.perspective_camera(45.0, 4.0 / 3.0, 0.1, 100.0, [0.0, 2.6, 6.6]!, [
		0.0,
		0.3,
		-0.1,
	]!, [0.0, 1.0, 0.0]!)
